...
st.markdown("Simulate and analyze your coffee roasting process with event-driven tracking")
...
# Footer
st.markdown("---")
st.markdown("Coffee Roasting Dashboard v1.0 | Event-Driven Roast Simulation")
